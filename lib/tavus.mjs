...
export function configFromEnv(env = process.env) {
  return {
    ...
    personaName: env.PERSONA_NAME || "Claude Video Agent",
    systemPrompt:
      env.PERSONA_SYSTEM_PROMPT ||
      "You are a warm, concise conversational video agent powered by Claude.",
    greeting:
      env.PERSONA_GREETING ||
      "Hi! I'm a video agent powered by Claude. What would you like to talk about?",
  };
}
